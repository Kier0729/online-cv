        ...
        <div className="container-outer">
            <div className="container-inner-about">
                <div className="contact-education">
                    ...
                    <h3 className="reddit-mono-h1">Training/Seminar</h3>
                    <p className="reddit-mono-h1">“The Complete 2024 <br></br>Web Development Bootcamp”<br></br>Udemy(March 2024) <span className="link" onClick={()=>{myContext.setClose(true)}}>View</span></p>
                </div>
                <div className="career-objective">
                    ...
                    <h3 className="reddit-mono-h1">Relevant Experience</h3>
                    <div>
